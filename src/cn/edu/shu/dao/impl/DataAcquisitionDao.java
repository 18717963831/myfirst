...
public class DataAcquisitionDao<T> implements IDataAcquisitionDao {
	 ...
	 * 验证用户
	 */
	public Map<String, String> checkUser(final String username, String password) {
	...
	@Override
	public int getNewestDeviceId() {
		// TODO Auto-generated method stub
		int deviceId=0;
	String sql=" select max(id) from device";
	try {
		 deviceId=qr.query(sql, new ScalarHandler<Integer>());
