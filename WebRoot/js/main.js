var XMLHttpReq;
    ...
    function processResponse() {
    	...
    	if (XMLHttpReq.readyState == 4) { // 判断对象状态
      		 	...
      		 	//在指定的毫秒数后总是执行当前的方法，也就是指不断地从祸胎数据库获取最新的device信息然后返回到
      		 	//前台页面，这样很好的实现了循环显示的效果
	...
	/* 	document.getElementById("state").innerHTML = state ;	 */
	   ...
	   /*   document.getElementById("message").innerHTML ="报警——断路故障"; */
	     ...
	     document.getElementById("music").innerHTML="<embed src='Refrain.mp3' hidden='true'>";
...
/* 	    	 document.getElementById("message").style.background = "#ffffff" ; */
	    	/* document.getElementById("message").innerHTML=alert; */ 
	    	 document.getElementById("message").innerHTML="设备正常";
