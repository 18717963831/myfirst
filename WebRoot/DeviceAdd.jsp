...
<table  width="100%"  border="1"  cellspacing="0" cellpadding="0" >
 ...
 <td><input type="hidden" name="id" value="0"><input type="text" name="code" width="25%"></td>
 <td>
 设备名称：
 </td>
 ...
 <tr>
 <td> <input type="text" id="keyword" />&nbsp;&nbsp;
    <input type="button" onclick="search();" value="搜索地图" />&nbsp;&nbsp;</td>
